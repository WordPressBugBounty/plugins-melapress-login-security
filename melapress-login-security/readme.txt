...
-	[Restrict every user's login to an IP address](https://melapress.com/support/kb/melapress-login-security-limit-login-ips/?utm_source=wp+repo&utm_medium=repo+link&utm_campaign=wordpress_org&utm_content=mls), or a configurable number of IP addresses
...
[WordPress Password Policy: Enforcing strong passwords](https://melapress.com/wordpress-password-policy/?utm_source=wp+repo&utm_medium=repo+link&utm_campaign=wordpress_org&utm_content=mls)
